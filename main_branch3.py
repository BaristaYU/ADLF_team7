...
def mainscreen(id,name):
    ...
    refresh_btn = Button(main,text='행복버튼',command = lambda: initial(main,id,init,mains))
    refresh_btn.place(x=1000,y=650,width=85,height=38)

    mainupdate()
    main.mainloop()

def initial(main,id,init,mains):
